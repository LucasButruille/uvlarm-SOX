...
def extract_bin():
    ...
    image = cv2.imread('/home/bot/Images/nukacola.png')
...
def template_matching():
    ...
    img_rgb = cv2.imread('/home/bot/Images/car.png')
    img_gray = cv2.cvtColor(img_rgb, cv2.COLOR_BGR2GRAY)


    # charger le template de l'objet à rechercher
    template = cv2.imread('/home/bot/Images/template.png',0)
